  ...
  const games: HobbyItem[] = [
    {
      title: 'Outer Wilds',
      description:
        'A mind-bending exploration game about unraveling the mysteries of a time-looped solar system.',
    ...
    },
    {
      title: 'Hollow Knight',
      description:
        'A beautifully crafted Metroidvania set in a haunting, atmospheric underground world.',
    ...
    },
    {
      title: 'OMORI',
      description:
        'A psychological RPG that explores memory, identity, and trauma through surreal storytelling.',
    ...
    },
    {
      title: 'Terraria',
      description:
        'A sandbox adventure game with crafting, exploration, and massive boss fights.',
    ...
    },
    {
      ...
      description:
        'A multiplayer survival game filled with strange creatures, dark nights, and harsh environments.',
    ...
    },
    {
      title: 'Shovel Knight',
      description:
        'A retro-inspired action platformer with tight gameplay and charming pixel art.',
  ...
  const movies: HobbyItem[] = [
    {
      ...
      description:
        'A gritty and emotional superhero film exploring justice, chaos, and morality.',
    ...
    },
    {
      title: 'The Departed',
      description:
        'An intense crime thriller about identity, loyalty, and deception.',
    ...
    },
    {
      title: 'Inception',
      description:
        'A dream-bending sci-fi thriller that dives deep into layers of the subconscious.',
    ...
    },
    {
      ...
      description:
        'A beautifully animated story about bullying, redemption, and forgiveness.',
    ...
    },
    {
      title: 'Snowpiercer',
      description:
        'A post-apocalyptic train ride through class warfare, survival, and revolution.',
    ...
    },
    {
      ...
      description:
        'A magical journey through a whimsical world of love, war, and transformation.',
  ...
  const manga: HobbyItem[] = [
    {
      title: 'Berserk',
      description:
        'A dark fantasy epic exploring trauma, revenge, and fate through unforgettable art.',
    ...
    },
    {
      title: 'Slam Dunk',
      description:
        'A sports manga with humor, character growth, and iconic basketball moments.',
    ...
    },
    {
      title: 'Chainsaw Man',
      description:
        'A chaotic blend of gore, humor, and heartbreak set in a devil-ridden world.',
    ...
    },
    {
      title: 'Death Note',
      description:
        'A psychological thriller of cat-and-mouse between two geniuses fighting over morality and justice.',
    ...
    },
    {
      title: 'Erased',
      description:
        'A time-travel mystery that explores regret, redemption, and child protection.',
    ...
    },
    {
      ...
      description:
        'A shonen adventure packed with rich world-building, clever battles, and emotional depth.',
          ...
          <div className="space-y-4 text-center">
            <div className="page-title inline-block p-4 mb-4">
              ...
              <p className="mx-auto max-w-[700px] text-muted-foreground md:text-lg ">
                <span>
                  A collection of my favorite games, movies, and manga.
                </span>
              </p>
            </div>
          </div>
