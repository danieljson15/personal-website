"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[6621],{20196:(e,t,s)=>{s.d(t,{t:()=>r});var a=s(35614);let l="gaussianSplatting",o=`fn getDataUV(index: f32,dataTextureSize: vec2f)->vec2<f32> {let y: f32=floor(index/dataTextureSize.x);let x: f32=index-y*dataTextureSize.x;return vec2f((x+0.5),(y+0.5));}
...
#endif
`;a.l.IncludesShadersStoreWGSL[l]||(a.l.IncludesShadersStoreWGSL[l]=o);let r={name:l,shader:o}},48318:(e,t,s)=>{s.d(t,{Z:()=>r});var a=s(35614);let l="meshUboDeclaration",o=`struct Mesh {world : mat4x4<f32>,
visibility : f32,};var<uniform> mesh : Mesh;
#define WORLD_UBO
`;a.l.IncludesShadersStoreWGSL[l]||(a.l.IncludesShadersStoreWGSL[l]=o);let r={name:l,shader:o}},95433:(e,t,s)=>{s.d(t,{e:()=>r});var a=s(35614);let l="sceneUboDeclaration",o=`struct Scene {viewProjection : mat4x4<f32>,
#ifdef MULTIVIEW
...
`;a.l.IncludesShadersStoreWGSL[l]||(a.l.IncludesShadersStoreWGSL[l]=o);let r={name:l,shader:o}},96621:(e,t,s)=>{s.r(t),s.d(t,{gaussianSplattingVoxelVertexShaderWGSL:()=>c});var a=s(35614),l=s(95433),o=s(48318),r=s(20196);let i="gaussianSplattingVoxelVertexShader",f=`#include<sceneUboDeclaration>
...
`;for(let e of(a.l.ShadersStoreWGSL[i]||(a.l.ShadersStoreWGSL[i]=f),[l.e,o.Z,r.t]))a.l.IncludesShadersStoreWGSL[e.name]||(a.l.IncludesShadersStoreWGSL[e.name]=e.shader);let c={name:i,shader:f}}}]);