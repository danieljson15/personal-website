"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[4143],{34143:(e,r,l)=>{l.r(r),l.d(r,{lodCubePixelShader:()=>a});var o=l(35614);let u="lodCubePixelShader",t=`precision highp float;const float GammaEncodePowerApprox=1.0/2.2;varying vec2 vUV;uniform samplerCube textureSampler;uniform float lod;uniform int gamma;void main(void)
{vec2 uv=vUV*2.0-1.0;
#ifdef POSITIVEX
...
`;o.l.ShadersStore[u]||(o.l.ShadersStore[u]=t);let a={name:u,shader:t}}}]);