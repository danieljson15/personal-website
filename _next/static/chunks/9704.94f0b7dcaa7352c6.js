"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[9704],{15379:(e,i,n)=>{n.d(i,{A:()=>E});var r=n(35614);let t="bumpVertexDeclaration",a=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL) 
varying vTBN0: vec3f;varying vTBN1: vec3f;varying vTBN2: vec3f;
#endif
#endif
`;r.l.IncludesShadersStoreWGSL[t]||(r.l.IncludesShadersStoreWGSL[t]=a);let E={name:t,shader:a}},42114:(e,i,n)=>{n.d(i,{Z:()=>E});var r=n(35614);let t="harmonicsFunctions",a=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
}`;for(let e of(r.l.ShadersStoreWGSL[b]||(r.l.ShadersStoreWGSL[b]=W),[t.e,a.Z,E.Y,f.$,o.u,l.f,c.$,_.j,N.J,s.K,I.u,d.O,A.Z,v.A,m.c,u.S,M.w,p.H,R.Y,T.R,S.L,x.v,C.f,V.g,D.U,O.l,L.n,U.u,F.h,h.c,G.K,g.y,P.s,X.l,Y.N,y.$]))r.l.IncludesShadersStoreWGSL[e.name]||(r.l.IncludesShadersStoreWGSL[e.name]=e.shader);let B={name:b,shader:W}}}]);