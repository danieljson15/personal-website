"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[2934],{13130:(e,i,o)=>{o.d(i,{$:()=>t});var r=o(35614);let n="sceneFragmentDeclaration",a=`uniform mat4 viewProjection;
#ifdef MULTIVIEW
uniform mat4 viewProjectionR;
#endif
uniform mat4 view;uniform mat4 projection;uniform vec4 vEyePosition;uniform mat4 inverseProjection;
`;r.l.IncludesShadersStore[n]||(r.l.IncludesShadersStore[n]=a);let t={name:n,shader:a}},18936:(e,i,o)=>{o.d(i,{B:()=>t});var r=o(35614);let n="openpbrSubsurfaceLayerData",a=`float subsurface_weight=vSubsurfaceWeight;vec3 subsurface_color=vSubsurfaceColor.rgb;float subsurface_radius=vSubsurfaceRadius;vec3 subsurface_radius_scale=vSubsurfaceRadiusScale;float subsurface_scatter_anisotropy=clamp(vSubsurfaceScatterAnisotropy,-0.9999,0.9999);
...
#endif
`;r.l.IncludesShadersStore[n]||(r.l.IncludesShadersStore[n]=a);let t={name:n,shader:a}},72328:(e,i,o)=>{o.d(i,{B:()=>t});var r=o(35614);let n="openpbrDielectricReflectance",a=`struct ReflectanceParams
...
`;r.l.IncludesShadersStore[f]||(r.l.IncludesShadersStore[f]=l);var d=o(28674),_=o(56503),m=o(85446),u=o(29680),v=o(96420),E=o(49030),g=o(74278),R=o(34098),I=o(75037);let p="openpbrFragmentSamplersDeclaration",T=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;r.l.IncludesShadersStore[p]||(r.l.IncludesShadersStore[p]=T);var S=o(22216),h=o(84010),A=o(22391),N=o(99058),b=o(71167),L=o(24755),F=o(59286),O=o(6317),C=o(3271),D=o(71649),M=o(66632),P=o(10455),G=o(94036),x=o(48109),y=o(69980),U=o(99641),z=o(80543),W=o(15460),w=o(93052);let B="openpbrNormalMapFragmentMainFunctions",X=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;r.l.IncludesShadersStore[B]||(r.l.IncludesShadersStore[B]=X);let H="openpbrNormalMapFragmentFunctions",V=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;r.l.IncludesShadersStore[H]||(r.l.IncludesShadersStore[H]=V);var k=o(21843),Y=o(72328);let Z="openpbrConductorReflectance",j=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;r.l.IncludesShadersStore[Z]||(r.l.IncludesShadersStore[Z]=j);let q="openpbrAmbientOcclusionFunctions",K=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;r.l.IncludesShadersStore[q]||(r.l.IncludesShadersStore[q]=K);var J=o(75438),Q=o(87924);let $="openpbrVolumeFunctions",ee=`struct OpenPBRHomogeneousVolume {vec3 extinction_coeff; 
vec3 ss_albedo; 
...
weight_sum.b<1e-5f ? unconvolved_irradiance.b : irradiance_sum.b/weight_sum.b);}`;r.l.IncludesShadersStore[$]||(r.l.IncludesShadersStore[$]=ee);var ei=o(68398),eo=o(60469);let er="openpbrNormalMapFragment",en=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;r.l.IncludesShadersStore[er]||(r.l.IncludesShadersStore[er]=en);let ea="openpbrBlockNormalFinal",et=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;r.l.IncludesShadersStore[ea]||(r.l.IncludesShadersStore[ea]=et);let es="openpbrBaseLayerData",ec=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;r.l.IncludesShadersStore[es]||(r.l.IncludesShadersStore[es]=ec);var ef=o(35271),el=o(18936);let ed="openpbrCoatLayerData",e_=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;r.l.IncludesShadersStore[ed]||(r.l.IncludesShadersStore[ed]=e_);let em="openpbrThinFilmLayerData",eu=`#ifdef THIN_FILM
...
#endif
`;r.l.IncludesShadersStore[em]||(r.l.IncludesShadersStore[em]=eu);let ev="openpbrFuzzLayerData",eE=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;r.l.IncludesShadersStore[ev]||(r.l.IncludesShadersStore[ev]=eE);let eg="openpbrAmbientOcclusionData",eR=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;r.l.IncludesShadersStore[eg]||(r.l.IncludesShadersStore[eg]=eR);var eI=o(44925);let ep="openpbrBackgroundTransmission",eT=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;r.l.IncludesShadersStore[ep]||(r.l.IncludesShadersStore[ep]=eT);let eS="openpbrEnvironmentLighting",eh=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;r.l.IncludesShadersStore[eS]||(r.l.IncludesShadersStore[eS]=eh);let eA="openpbrDirectLightingInit",eN=`#ifdef LIGHT{X}
...
#endif
#endif
`;r.l.IncludesShadersStore[eA]||(r.l.IncludesShadersStore[eA]=eN);let eb="openpbrDirectLighting",eL=`#ifdef LIGHT{X}
...
#endif
`;r.l.IncludesShadersStore[eb]||(r.l.IncludesShadersStore[eb]=eL);var eF=o(60889),eO=o(72358),eC=o(95827);let eD="openpbrBlockPrePass",eM=`#if SCENE_MRT_COUNT>0
#ifdef ALPHATEST
...
#endif
#ifdef PREPASS_ALBEDO_SQRT
WRITE_GEOMETRY_FRAGMENT_OUTPUT(PREPASS_ALBEDO_SQRT_INDEX,vec4(sqAlbedo,writeGeometryInfo)); 
#endif
...
#endif
#endif
`;r.l.IncludesShadersStore[eD]||(r.l.IncludesShadersStore[eD]=eM);var eP=o(8110),eG=o(15529);let ex="openpbrPixelShader",ey=`#define OPENPBR_FRAGMENT_SHADER
...
`;for(let e of(r.l.ShadersStore[ex]||(r.l.ShadersStore[ex]=ey),[n._,a.$,t.v,s.$,c.c,{name:f,shader:l},d.f,_.q,m.R,u.F,v.N,E.l,g.V,R.b,I.a,{name:p,shader:T},S.$,h.T,A._,N.V,b.k,L.q,F.R,O.o,C.k,D.O,M.$,P.S,G.H,x.s,y.D,U.G,z.E,W.v,w.r,{name:B,shader:X},{name:H,shader:V},k.e,Y.B,{name:Z,shader:j},{name:q,shader:K},J.R,Q.d,{name:$,shader:ee},ei.t,eo.A,{name:er,shader:en},{name:ea,shader:et},{name:es,shader:ec},ef.O,el.B,{name:ed,shader:e_},{name:em,shader:eu},{name:ev,shader:eE},{name:eg,shader:eR},eI.O,{name:ep,shader:eT},{name:eS,shader:eh},{name:eA,shader:eN},{name:eb,shader:eL},eF.w,eO.f,eC.U,{name:eD,shader:eM},eP.P,eG.I]))r.l.IncludesShadersStore[e.name]||(r.l.IncludesShadersStore[e.name]=e.shader);let eU={name:ex,shader:ey}},75438:(e,i,o)=>{o.d(i,{R:()=>t});var r=o(35614);let n="openpbrGeometryInfo",a=`struct geometryInfoOutParams
...
#endif
`;r.l.IncludesShadersStore[n]||(r.l.IncludesShadersStore[n]=a);let t={name:n,shader:a}}}]);