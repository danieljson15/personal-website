"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[7024],{3271:(e,t,o)=>{o.d(t,{k:()=>n});var i=o(35614);let a="pbrHelperFunctions",r=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;i.l.IncludesShadersStore[a]||(i.l.IncludesShadersStore[a]=r);let n={name:a,shader:r}},6317:(e,t,o)=>{o.d(t,{o:()=>n});var i=o(35614);let a="importanceSampling",r=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;i.l.IncludesShadersStore[a]||(i.l.IncludesShadersStore[a]=r);let n={name:a,shader:r}},10455:(e,t,o)=>{o.d(t,{S:()=>n});var i=o(35614);let a="harmonicsFunctions",r=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;i.l.IncludesShadersStore[a]||(i.l.IncludesShadersStore[a]=r);let n={name:a,shader:r}},15460:(e,t,o)=>{o.d(t,{v:()=>n});var i=o(35614);let a="pbrDirectLightingFunctions",r=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
vec3 computeOpenPBRAreaSpecularLighting(preLightingInfo info,vec3 lightColor,vec3 reflectance0,vec3 reflectance90) {vec3 fresnel=reflectance0*info.areaLightFresnel.x+(reflectance90-reflectance0)*info.areaLightFresnel.y;return lightColor*fresnel*info.areaLightSpecular;}
#if CONDUCTOR_SPECULAR_MODEL==CONDUCTOR_SPECULAR_MODEL_OPENPBR
vec3 computeOpenPBRAreaConductorSpecularLighting(preLightingInfo info,vec3 lightColor,vec3 reflectance0,vec3 edgeTint) {vec3 b=getF82B(reflectance0,edgeTint);float normalizedSchlickMoment=clamp(info.areaLightFresnel.y/max(info.areaLightFresnel.x,Epsilon),0.0,1.0);float representativeOneMinusCosTheta=pow(normalizedSchlickMoment,0.2);float f82DipMoment=info.areaLightFresnel.y*representativeOneMinusCosTheta*(1.0-representativeOneMinusCosTheta);vec3 fresnel=reflectance0*info.areaLightFresnel.x+(vec3(1.0)-reflectance0)*info.areaLightFresnel.y-b*f82DipMoment;return lightColor*clamp(fresnel,vec3(0.0),vec3(info.areaLightFresnel.x))*info.areaLightSpecular;}
#endif
float computeOpenPBRAreaFresnel(preLightingInfo info,float reflectance0,float reflectance90) {return reflectance0*info.areaLightFresnel.x+(reflectance90-reflectance0)*info.areaLightFresnel.y;}
#endif
#endif
#ifdef FUZZ
...
#endif
`;i.l.IncludesShadersStore[a]||(i.l.IncludesShadersStore[a]=r);let n={name:a,shader:r}},15529:(e,t,o)=>{o.d(t,{I:()=>n});var i=o(35614);let a="pbrDebug",r=`#if DEBUGMODE>0
...
WRITE_GEOMETRY_FRAGMENT_OUTPUT(0,toLinearSpace(gl_FragColor)); 
#endif
#if !defined(PREPASS_OBJECT_ID) || PREPASS_OBJECT_ID_INDEX != 1
WRITE_GEOMETRY_FRAGMENT_OUTPUT(1,vec4(0.,0.,0.,0.)); 
#endif
#endif
...
#endif
`;i.l.IncludesShadersStore[a]||(i.l.IncludesShadersStore[a]=r);let n={name:a,shader:r}},48109:(e,t,o)=>{o.d(t,{s:()=>n});var i=o(35614);o(94036);let a="pbrDirectLightingSetupFunctions",r=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;i.l.IncludesShadersStore[a]||(i.l.IncludesShadersStore[a]=r);let n={name:a,shader:r}},59286:(e,t,o)=>{o.d(t,{R:()=>n});var i=o(35614);let a="subSurfaceScatteringFunctions",r=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;i.l.IncludesShadersStore[a]||(i.l.IncludesShadersStore[a]=r);let n={name:a,shader:r}},60469:(e,t,o)=>{o.d(t,{A:()=>n});var i=o(35614);let a="pbrBlockNormalGeometric",r=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;i.l.IncludesShadersStore[a]||(i.l.IncludesShadersStore[a]=r);let n={name:a,shader:r}},69980:(e,t,o)=>{o.d(t,{D:()=>n});var i=o(35614);let a="pbrDirectLightingFalloffFunctions",r=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;i.l.IncludesShadersStore[a]||(i.l.IncludesShadersStore[a]=r);let n={name:a,shader:r}},75037:(e,t,o)=>{o.d(t,{a:()=>n});var i=o(35614);let a="pbrFragmentReflectionDeclaration",r=`#ifdef REFLECTION
...
#endif
#endif
`;i.l.IncludesShadersStore[a]||(i.l.IncludesShadersStore[a]=r);let n={name:a,shader:r}},80543:(e,t,o)=>{o.d(t,{E:()=>n});var i=o(35614);let a="hdrFilteringFunctions",r=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
precision highp int;float radicalInverse_VdC(uint bits)
...
#endif
#endif
`;i.l.IncludesShadersStore[a]||(i.l.IncludesShadersStore[a]=r);let n={name:a,shader:r}},93052:(e,t,o)=>{o.d(t,{r:()=>n});var i=o(35614);let a="pbrIBLFunctions",r=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;i.l.IncludesShadersStore[a]||(i.l.IncludesShadersStore[a]=r);let n={name:a,shader:r}},95827:(e,t,o)=>{o.d(t,{U:()=>n});var i=o(35614);let a="pbrBlockImageProcessing",r=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;i.l.IncludesShadersStore[a]||(i.l.IncludesShadersStore[a]=r);let n={name:a,shader:r}},96420:(e,t,o)=>{o.d(t,{N:()=>n});var i=o(35614);o(29680);let a="pbrFragmentExtraDeclaration",r=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;i.l.IncludesShadersStore[a]||(i.l.IncludesShadersStore[a]=r);let n={name:a,shader:r}},99641:(e,t,o)=>{o.d(t,{G:()=>n});var i=o(35614);let a="pbrBRDFFunctions",r=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif 
`;i.l.IncludesShadersStore[a]||(i.l.IncludesShadersStore[a]=r);let n={name:a,shader:r}}}]);