"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[8400],{22269:(e,r,i)=>{i.d(r,{I:()=>o});var a=i(35614);let n="openpbrGeometryInfo",t=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;a.l.IncludesShadersStoreWGSL[n]||(a.l.IncludesShadersStoreWGSL[n]=t);let o={name:n,shader:t}},68400:(e,r,i)=>{i.r(r),i.d(r,{openpbrPixelShaderWGSL:()=>ey});var a=i(35614),n=i(71866),t=i(79171),o=i(42271),f=i(95433),s=i(48318),l=i(69729),c=i(82321),m=i(62799),d=i(87261),_=i(10123),u=i(88404);let v="openpbrFragmentSamplersDeclaration",p=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;a.l.IncludesShadersStoreWGSL[v]||(a.l.IncludesShadersStoreWGSL[v]=p);var g=i(76349),E=i(52079),S=i(50064),I=i(30027),R=i(68234),h=i(15640),T=i(3705),A=i(58776),N=i(18302),b=i(63004),L=i(48409),F=i(42114),C=i(8433),O=i(64566),D=i(44131),P=i(27584),x=i(84656),M=i(99747),G=i(62116),y=i(47745),W=i(22617),z=i(47607);let U="openpbrNormalMapFragmentMainFunctions",w=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;a.l.IncludesShadersStoreWGSL[U]||(a.l.IncludesShadersStoreWGSL[U]=w);let B="openpbrNormalMapFragmentFunctions",X=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;a.l.IncludesShadersStoreWGSL[B]||(a.l.IncludesShadersStoreWGSL[B]=X);var V=i(7482),H=i(83737);let k="openpbrConductorReflectance",Y=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;a.l.IncludesShadersStoreWGSL[k]||(a.l.IncludesShadersStoreWGSL[k]=Y);let Z="openpbrAmbientOcclusionFunctions",j=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;a.l.IncludesShadersStoreWGSL[Z]||(a.l.IncludesShadersStoreWGSL[Z]=j);var q=i(22269),K=i(85059);let J="openpbrVolumeFunctions",Q=`struct OpenPBRHomogeneousVolume {extinction_coeff: vec3f, 
ss_albedo: vec3f, 
...
`;a.l.IncludesShadersStoreWGSL[J]||(a.l.IncludesShadersStoreWGSL[J]=Q);var $=i(39489),ee=i(41358);let er="openpbrNormalMapFragment",ei=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;a.l.IncludesShadersStoreWGSL[er]||(a.l.IncludesShadersStoreWGSL[er]=ei);let ea="openpbrBlockNormalFinal",en=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;a.l.IncludesShadersStoreWGSL[ea]||(a.l.IncludesShadersStoreWGSL[ea]=en);let et="openpbrBaseLayerData",eo=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;a.l.IncludesShadersStoreWGSL[et]||(a.l.IncludesShadersStoreWGSL[et]=eo);var ef=i(81606),es=i(76437);let el="openpbrCoatLayerData",ec=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;a.l.IncludesShadersStoreWGSL[el]||(a.l.IncludesShadersStoreWGSL[el]=ec);let em="openpbrThinFilmLayerData",ed=`#ifdef THIN_FILM
...
#endif
`;a.l.IncludesShadersStoreWGSL[em]||(a.l.IncludesShadersStoreWGSL[em]=ed);let e_="openpbrFuzzLayerData",eu=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;a.l.IncludesShadersStoreWGSL[e_]||(a.l.IncludesShadersStoreWGSL[e_]=eu);let ev="openpbrAmbientOcclusionData",ep=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;a.l.IncludesShadersStoreWGSL[ev]||(a.l.IncludesShadersStoreWGSL[ev]=ep);var eg=i(35160);let eE="openpbrBackgroundTransmission",eS=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;a.l.IncludesShadersStoreWGSL[eE]||(a.l.IncludesShadersStoreWGSL[eE]=eS);let eI="openpbrEnvironmentLighting",eR=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;a.l.IncludesShadersStoreWGSL[eI]||(a.l.IncludesShadersStoreWGSL[eI]=eR);let eh="openpbrDirectLightingInit",eT=`#ifdef LIGHT{X}
...
#endif
#endif
`;a.l.IncludesShadersStoreWGSL[eh]||(a.l.IncludesShadersStoreWGSL[eh]=eT);let eA="openpbrDirectLighting",eN=`#ifdef LIGHT{X}
...
#endif
`;a.l.IncludesShadersStoreWGSL[eA]||(a.l.IncludesShadersStoreWGSL[eA]=eN);var eb=i(65016),eL=i(3893),eF=i(77168),eC=i(62090);let eO="openpbrBlockPrePass",eD=`#if SCENE_MRT_COUNT>0
#ifdef ALPHATEST
...
#endif
`;a.l.IncludesShadersStoreWGSL[eO]||(a.l.IncludesShadersStoreWGSL[eO]=eD);var eP=i(74673),ex=i(13280);let eM="openpbrPixelShader",eG=`#define OPENPBR_FRAGMENT_SHADER
...
#endif
`;a.l.IncludesShadersStoreWGSL[n]||(a.l.IncludesShadersStoreWGSL[n]=t);let o={name:n,shader:t}},83737:(e,r,i)=>{i.d(r,{E:()=>o});var a=i(35614);let n="openpbrDielectricReflectance",t=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;a.l.IncludesShadersStoreWGSL[n]||(a.l.IncludesShadersStoreWGSL[n]=t);let o={name:n,shader:t}},85059:(e,r,i)=>{i.d(r,{O:()=>o});var a=i(35614);let n="openpbrIblFunctions",t=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
#if defined(NORMAL) && defined(USESPHERICALINVERTEX)
...
#endif
`;a.l.IncludesShadersStoreWGSL[n]||(a.l.IncludesShadersStoreWGSL[n]=t);let o={name:n,shader:t}}}]);