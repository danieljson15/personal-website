"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[2487],{10455:(e,o,i)=>{i.d(o,{S:()=>r});var n=i(35614);let t="harmonicsFunctions",a=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;n.l.IncludesShadersStore[t]||(n.l.IncludesShadersStore[t]=a);let r={name:t,shader:a}},12487:(e,o,i)=>{i.r(o),i.d(o,{openpbrVertexShader:()=>w});var n=i(35614),t=i(57728),a=i(78819);let r="openpbrVertexDeclaration",s=`#include<sceneVertexDeclaration>
#ifdef BASE_COLOR
...
`;n.l.IncludesShadersStore[r]||(n.l.IncludesShadersStore[r]=s);var l=i(28674),f=i(56503),c=i(85446),E=i(66701),_=i(29680),N=i(24755),d=i(99641),m=i(2099),I=i(69969),u=i(87194),v=i(81860),A=i(17400),R=i(10455);let p="openpbrNormalMapVertexDeclaration",M=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#endif
`;n.l.IncludesShadersStore[p]||(n.l.IncludesShadersStore[p]=M);var S=i(87456),h=i(52120),T=i(48612),O=i(60640),C=i(76481),F=i(25108),D=i(22391),x=i(38351),g=i(24020),V=i(39592),G=i(26283),L=i(35583),b=i(21956),U=i(47587),P=i(86466);let B="openpbrNormalMapVertex",y=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
vec3 tbnNormal=normalize(normalUpdated);vec3 tbnTangent=normalize(tangentUpdated.xyz);vec3 tbnBitangent=cross(tbnNormal,tbnTangent)*tangentUpdated.w;vTBN=mat3(finalWorld)*mat3(tbnTangent,tbnBitangent,tbnNormal);
#endif
#endif
`;n.l.IncludesShadersStore[B]||(n.l.IncludesShadersStore[B]=y);var W=i(16088),Y=i(35616),H=i(13037),z=i(15361),X=i(1463);let k="openpbrVertexShader",Z=`#define OPENPBR_VERTEX_SHADER
...
#endif
#endif 
`;n.l.IncludesShadersStore[t]||(n.l.IncludesShadersStore[t]=a);let r={name:t,shader:a}}}]);