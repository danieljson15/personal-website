"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[1652],{3705:(e,i,t)=>{t.d(i,{S:()=>a});var r=t(35614);let f="subSurfaceScatteringFunctions",n=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;r.l.IncludesShadersStoreWGSL[f]||(r.l.IncludesShadersStoreWGSL[f]=n);let a={name:f,shader:n}},13280:(e,i,t)=>{t.d(i,{N:()=>a});var r=t(35614);let f="pbrDebug",n=`#if DEBUGMODE>0
...
fragmentOutputs.fragData0=vec4f(toLinearSpaceVec3(color),1.0); 
#endif
...
#endif
`;r.l.IncludesShadersStoreWGSL[f]||(r.l.IncludesShadersStoreWGSL[f]=n);let a={name:f,shader:n}},18302:(e,i,t)=>{t.d(i,{p:()=>a});var r=t(35614);let f="pbrHelperFunctions",n=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;r.l.IncludesShadersStoreWGSL[f]||(r.l.IncludesShadersStoreWGSL[f]=n);let a={name:f,shader:n}},22617:(e,i,t)=>{t.d(i,{S:()=>a});var r=t(35614);t(99747),t(47745);let f="pbrDirectLightingFunctions",n=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
#endif
`;r.l.IncludesShadersStoreWGSL[f]||(r.l.IncludesShadersStoreWGSL[f]=n);let a={name:f,shader:n}},41358:(e,i,t)=>{t.d(i,{F:()=>a});var r=t(35614);let f="pbrBlockNormalGeometric",n=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;r.l.IncludesShadersStoreWGSL[f]||(r.l.IncludesShadersStoreWGSL[f]=n);let a={name:f,shader:n}},42114:(e,i,t)=>{t.d(i,{Z:()=>a});var r=t(35614);let f="harmonicsFunctions",n=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;r.l.IncludesShadersStoreWGSL[f]||(r.l.IncludesShadersStoreWGSL[f]=n);let a={name:f,shader:n}},44131:(e,i,t)=>{t.d(i,{_:()=>a});var r=t(35614);let f="pbrDirectLightingFalloffFunctions",n=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;r.l.IncludesShadersStoreWGSL[f]||(r.l.IncludesShadersStoreWGSL[f]=n);let a={name:f,shader:n}},47607:(e,i,t)=>{t.d(i,{S:()=>a});var r=t(35614);let f="pbrIBLFunctions",n=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;r.l.IncludesShadersStoreWGSL[f]||(r.l.IncludesShadersStoreWGSL[f]=n);let a={name:f,shader:n}},47745:(e,i,t)=>{t.d(i,{M:()=>a});var r=t(35614);t(62116);let f="pbrClusteredLightingFunctions",n=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;r.l.IncludesShadersStoreWGSL[f]||(r.l.IncludesShadersStoreWGSL[f]=n);let a={name:f,shader:n}},62116:(e,i,t)=>{t.d(i,{v:()=>a});var r=t(35614);let f="pbrBlockReflectance0",n=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;r.l.IncludesShadersStoreWGSL[f]||(r.l.IncludesShadersStoreWGSL[f]=n);let a={name:f,shader:n}},62799:(e,i,t)=>{t.d(i,{w:()=>a});var r=t(35614);t(82321);let f="pbrFragmentExtraDeclaration",n=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;r.l.IncludesShadersStoreWGSL[f]||(r.l.IncludesShadersStoreWGSL[f]=n);let a={name:f,shader:n}},64566:(e,i,t)=>{t.d(i,{b:()=>a});var r=t(35614);t(8433);let f="pbrDirectLightingSetupFunctions",n=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;r.l.IncludesShadersStoreWGSL[f]||(r.l.IncludesShadersStoreWGSL[f]=n);let a={name:f,shader:n}},77168:(e,i,t)=>{t.d(i,{L:()=>a});var r=t(35614);let f="pbrBlockImageProcessing",n=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;r.l.IncludesShadersStoreWGSL[f]||(r.l.IncludesShadersStoreWGSL[f]=n);let a={name:f,shader:n}},84656:(e,i,t)=>{t.d(i,{B:()=>a});var r=t(35614);let f="hdrFilteringFunctions",n=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;r.l.IncludesShadersStoreWGSL[f]||(r.l.IncludesShadersStoreWGSL[f]=n);let a={name:f,shader:n}},88404:(e,i,t)=>{t.d(i,{B:()=>a});var r=t(35614);let f="pbrFragmentReflectionDeclaration",n=`#ifdef REFLECTION
...
#endif
#endif
`;r.l.IncludesShadersStoreWGSL[f]||(r.l.IncludesShadersStoreWGSL[f]=n);let a={name:f,shader:n}}}]);