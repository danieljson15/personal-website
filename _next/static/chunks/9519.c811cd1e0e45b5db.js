...
`;a.l.IncludesShadersStoreWGSL[c]||(a.l.IncludesShadersStoreWGSL[c]=n);let f={name:c,shader:n}},39519:(e,r,t)=>{t.r(r),t.d(r,{rgbdDecodePixelShaderWGSL:()=>o});var a=t(35614),c=t(15640);let n="rgbdDecodePixelShader",f=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;
#include<helperFunctions>
#define CUSTOM_FRAGMENT_DEFINITIONS
@fragment
fn main(input: FragmentInputs)->FragmentOutputs {fragmentOutputs.color=vec4f(fromRGBD(textureSample(textureSampler,textureSamplerSampler,input.vUV)),1.0);}`;for(let e of(a.l.ShadersStoreWGSL[n]||(a.l.ShadersStoreWGSL[n]=f),[c.f]))a.l.IncludesShadersStoreWGSL[e.name]||(a.l.IncludesShadersStoreWGSL[e.name]=e.shader);let o={name:n,shader:f}}}]);