"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[9064],{7839:(e,t,a)=>{a.d(t,{k:()=>l});var s=a(35614);let o="gaussianSplatting",i=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
...
#endif
`;s.l.IncludesShadersStore[o]||(s.l.IncludesShadersStore[o]=i);let l={name:o,shader:i}},9843:(e,t,a)=>{a.d(t,{Q:()=>l});var s=a(35614);let o="gaussianSplattingVertexDeclaration",i="attribute vec3 position;attribute vec4 splatIndex0;attribute vec4 splatIndex1;attribute vec4 splatIndex2;attribute vec4 splatIndex3;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;";s.l.IncludesShadersStore[o]||(s.l.IncludesShadersStore[o]=i);let l={name:o,shader:i}},28674:(e,t,a)=>{a.d(t,{f:()=>l});var s=a(35614);let o="sceneUboDeclaration",i=`layout(std140,column_major) uniform;uniform Scene {mat4 viewProjection;
#ifdef MULTIVIEW
mat4 viewProjectionR;
#endif 
mat4 view;mat4 projection;vec4 vEyePosition;mat4 inverseProjection;};
`;s.l.IncludesShadersStore[o]||(s.l.IncludesShadersStore[o]=i);let l={name:o,shader:i}},56503:(e,t,a)=>{a.d(t,{q:()=>l});var s=a(35614);let o="meshUboDeclaration",i=`#ifdef WEBGL2
...
#endif
#define WORLD_UBO
`;s.l.IncludesShadersStore[o]||(s.l.IncludesShadersStore[o]=i);let l={name:o,shader:i}},79064:(e,t,a)=>{a.r(t),a.d(t,{gaussianSplattingVoxelVertexShader:()=>x});var s=a(35614),o=a(9843),i=a(28674),l=a(56503),c=a(82535),r=a(7839);let n="gaussianSplattingVoxelVertexShader",d=`#include<__decl__gaussianSplattingVertex>
...
#endif
vPatchPosition=position.xy;}`;for(let e of(s.l.ShadersStore[n]||(s.l.ShadersStore[n]=d),[o.Q,i.f,l.q,c.c,r.k]))s.l.IncludesShadersStore[e.name]||(s.l.IncludesShadersStore[e.name]=e.shader);let x={name:n,shader:d}},82535:(e,t,a)=>{a.d(t,{c:()=>l});var s=a(35614);a(28674),a(56503);let o="gaussianSplattingUboDeclaration",i=`#include<sceneUboDeclaration>
...
`;s.l.IncludesShadersStore[o]||(s.l.IncludesShadersStore[o]=i);let l={name:o,shader:i}}}]);