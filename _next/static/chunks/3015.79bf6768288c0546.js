"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[3015],{15640:(e,r,i)=>{i.d(r,{f:()=>a});var f=i(35614);let o="helperFunctions",t=`const PI: f32=3.1415926535897932384626433832795;const TWO_PI: f32=6.283185307179586;const HALF_PI: f32=1.5707963267948966;const RECIPROCAL_PI: f32=0.3183098861837907;const RECIPROCAL_PI2: f32=0.15915494309189535;const RECIPROCAL_PI4: f32=0.07957747154594767;const HALF_MIN: f32=5.96046448e-08; 
...
`;f.l.IncludesShadersStoreWGSL[o]||(f.l.IncludesShadersStoreWGSL[o]=t);let a={name:o,shader:t}},44412:(e,r,i)=>{i.d(r,{J:()=>a});var f=i(35614);i(95433),i(48318);let o="defaultUboDeclaration",t=`uniform diffuseLeftColor: vec4f;uniform diffuseRightColor: vec4f;uniform opacityParts: vec4f;uniform reflectionLeftColor: vec4f;uniform reflectionRightColor: vec4f;uniform refractionLeftColor: vec4f;uniform refractionRightColor: vec4f;uniform emissiveLeftColor: vec4f;uniform emissiveRightColor: vec4f;uniform vDiffuseInfos: vec2f;uniform vAmbientInfos: vec2f;uniform vOpacityInfos: vec2f;uniform vEmissiveInfos: vec2f;uniform vLightmapInfos: vec2f;uniform vSpecularInfos: vec2f;uniform vBumpInfos: vec3f;uniform diffuseMatrix: mat4x4f;uniform ambientMatrix: mat4x4f;uniform opacityMatrix: mat4x4f;uniform emissiveMatrix: mat4x4f;uniform lightmapMatrix: mat4x4f;uniform specularMatrix: mat4x4f;uniform bumpMatrix: mat4x4f;uniform vTangentSpaceParams: vec2f;uniform pointSize: f32;uniform alphaCutOff: f32;uniform refractionMatrix: mat4x4f;uniform vRefractionInfos: vec4f;uniform vRefractionPosition: vec3f;uniform vRefractionSize: vec3f;uniform vSpecularColor: vec4f;uniform vEmissiveColor: vec3f;uniform vDiffuseColor: vec4f;uniform vAmbientColor: vec3f;uniform cameraInfo: vec4f;uniform vTextureRepetitionHexTilingParams: vec4f;uniform vReflectionInfos: vec2f;uniform reflectionMatrix: mat4x4f;uniform vReflectionPosition: vec3f;uniform vReflectionSize: vec3f;
#define ADDITIONAL_UBO_DECLARATION
#include<sceneUboDeclaration>
#include<meshUboDeclaration>
`;f.l.IncludesShadersStoreWGSL[o]||(f.l.IncludesShadersStoreWGSL[o]=t);let a={name:o,shader:t}},83015:(e,r,i)=>{i.r(r),i.d(r,{defaultPixelShaderWGSL:()=>z});var f=i(35614),o=i(95433),t=i(48318),a=i(44412),n=i(71866),l=i(79171),c=i(42271),s=i(82321),v=i(15640),u=i(87261),m=i(8433),d=i(99747);let g="clusteredLightingCompute",p=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;f.l.IncludesShadersStoreWGSL[g]||(f.l.IncludesShadersStoreWGSL[g]=p);let S="lightsFragmentFunctions",E=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;f.l.IncludesShadersStoreWGSL[S]||(f.l.IncludesShadersStoreWGSL[S]=E);var C=i(48409),I=i(10123);let A="fresnelFunction",R=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;f.l.IncludesShadersStoreWGSL[A]||(f.l.IncludesShadersStoreWGSL[A]=R);var L=i(7482),P=i(76349),h=i(63004),T=i(68234),D=i(6851),_=i(34376),x=i(52079),N=i(50064),b=i(30027),O=i(39489),M=i(78199),F=i(98624),W=i(35160),G=i(38309),y=i(65016),U=i(3893),V=i(62090),w=i(74673);let H="defaultPixelShader",B=`#include<defaultUboDeclaration>
...
`;for(let e of(f.l.ShadersStoreWGSL[H]||(f.l.ShadersStoreWGSL[H]=B),[o.e,t.Z,a.J,n.n,l.I,c.O,s.u,v.f,u.Y,m.S,d.u,{name:g,shader:p},{name:S,shader:E},C.W,I.w,{name:A,shader:R},L.x,P.i,h.P,T.D,D.C,_.d,x.O,N.R,b.s,O.O,M.o,F.N,W.P,G.S,y.$,U.m,V.P,w.K]))f.l.IncludesShadersStoreWGSL[e.name]||(f.l.IncludesShadersStoreWGSL[e.name]=e.shader);let z={name:H,shader:B}},95433:(e,r,i)=>{i.d(r,{e:()=>a});var f=i(35614);let o="sceneUboDeclaration",t=`struct Scene {viewProjection : mat4x4<f32>,
#ifdef MULTIVIEW
...
`;f.l.IncludesShadersStoreWGSL[o]||(f.l.IncludesShadersStoreWGSL[o]=t);let a={name:o,shader:t}}}]);