...
#endif
#endif
`;r.l.IncludesShadersStoreWGSL[S]||(r.l.IncludesShadersStoreWGSL[S]=m);var v=a(88404);let u="pbrFragmentSamplersDeclaration",C=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;r.l.IncludesShadersStoreWGSL[u]||(r.l.IncludesShadersStoreWGSL[u]=C);var I=a(76349),A=a(52079),p=a(50064),N=a(30027),O=a(68234),T=a(15640),L=a(3705),_=a(58776),M=a(18302),D=a(63004),P=a(48409),F=a(42114),h=a(8433),g=a(64566),U=a(44131),b=a(27584),y=a(84656),B=a(99747),G=a(62116),V=a(47745),x=a(22617),H=a(47607),W=a(6851),Y=a(34376),X=a(7482),w=a(98624);let k="pbrBlockAlbedoOpacity",z=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;r.l.IncludesShadersStoreWGSL[k]||(r.l.IncludesShadersStoreWGSL[k]=z);let K="pbrBlockReflectivity",Z=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;r.l.IncludesShadersStoreWGSL[K]||(r.l.IncludesShadersStoreWGSL[K]=Z);let q="pbrBlockAmbientOcclusion",J=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;r.l.IncludesShadersStoreWGSL[q]||(r.l.IncludesShadersStoreWGSL[q]=J);let Q="pbrBlockAlphaFresnel",j=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;r.l.IncludesShadersStoreWGSL[Q]||(r.l.IncludesShadersStoreWGSL[Q]=j);let $="pbrBlockAnisotropic",ee=`#ifdef ANISOTROPIC
...
#endif
`;r.l.IncludesShadersStoreWGSL[$]||(r.l.IncludesShadersStoreWGSL[$]=ee);let ei="pbrBlockReflection",ea=`#ifdef REFLECTION
...
#endif
`;r.l.IncludesShadersStoreWGSL[ei]||(r.l.IncludesShadersStoreWGSL[ei]=ea);let er="pbrBlockSheen",en=`#ifdef SHEEN
...
#endif
`;r.l.IncludesShadersStoreWGSL[er]||(r.l.IncludesShadersStoreWGSL[er]=en);let ef="pbrBlockClearcoat",eo=`struct clearcoatOutParams
...
return outParams;}
#endif
`;r.l.IncludesShadersStoreWGSL[ef]||(r.l.IncludesShadersStoreWGSL[ef]=eo);let et="pbrBlockIridescence",ec=`struct iridescenceOutParams
...
#endif
`;r.l.IncludesShadersStoreWGSL[et]||(r.l.IncludesShadersStoreWGSL[et]=ec);let el="pbrBlockSubSurface",ed=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;r.l.IncludesShadersStoreWGSL[el]||(r.l.IncludesShadersStoreWGSL[el]=ed);var es=a(39489),eE=a(41358),eR=a(78199);let eS="pbrBlockNormalFinal",em=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;r.l.IncludesShadersStoreWGSL[eS]||(r.l.IncludesShadersStoreWGSL[eS]=em);var ev=a(35160);let eu="pbrBlockLightmapInit",eC=`#ifdef LIGHTMAP
...
#endif
`;r.l.IncludesShadersStoreWGSL[eu]||(r.l.IncludesShadersStoreWGSL[eu]=eC);let eI="pbrBlockGeometryInfo",eA=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;r.l.IncludesShadersStoreWGSL[eI]||(r.l.IncludesShadersStoreWGSL[eI]=eA);let ep="pbrBlockReflectance",eN=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;r.l.IncludesShadersStoreWGSL[ep]||(r.l.IncludesShadersStoreWGSL[ep]=eN);let eO="pbrBlockDirectLighting",eT=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;r.l.IncludesShadersStoreWGSL[eO]||(r.l.IncludesShadersStoreWGSL[eO]=eT);var eL=a(38309);let e_="pbrBlockFinalLitComponents",eM=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;r.l.IncludesShadersStoreWGSL[e_]||(r.l.IncludesShadersStoreWGSL[e_]=eM);let eD="pbrBlockFinalUnlitComponents",eP=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;r.l.IncludesShadersStoreWGSL[eD]||(r.l.IncludesShadersStoreWGSL[eD]=eP);let eF="pbrBlockFinalColorComposition",eh=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;r.l.IncludesShadersStoreWGSL[eF]||(r.l.IncludesShadersStoreWGSL[eF]=eh);var eg=a(65016),eU=a(3893),eb=a(77168),ey=a(62090);let eB="pbrBlockPrePass",eG=`#if SCENE_MRT_COUNT>0
#ifdef ALPHATEST
...
#endif
`;r.l.IncludesShadersStoreWGSL[eB]||(r.l.IncludesShadersStoreWGSL[eB]=eG);var eV=a(74673),ex=a(13280);let eH="pbrPixelShader",eW=`#define PBR_FRAGMENT_SHADER
...
`;for(let e of(r.l.ShadersStoreWGSL[eH]||(r.l.ShadersStoreWGSL[eH]=eW),[n.n,f.I,o.O,t.e,c.Z,l.Y,d.u,s.w,E.Y,R.w,{name:S,shader:m},v.B,{name:u,shader:C},I.i,A.O,p.R,N.s,O.D,T.f,L.S,_.f,M.p,D.P,P.W,F.Z,h.S,g.b,U._,b.$,y.B,B.u,G.v,V.M,x.S,H.S,W.C,Y.d,X.x,w.N,{name:k,shader:z},{name:K,shader:Z},{name:q,shader:J},{name:Q,shader:j},{name:$,shader:ee},{name:ei,shader:ea},{name:er,shader:en},{name:ef,shader:eo},{name:et,shader:ec},{name:el,shader:ed},es.O,eE.F,eR.o,{name:eS,shader:em},ev.P,{name:eu,shader:eC},{name:eI,shader:eA},{name:ep,shader:eN},{name:eO,shader:eT},eL.S,{name:e_,shader:eM},{name:eD,shader:eP},{name:eF,shader:eh},eg.$,eU.m,eb.L,ey.P,{name:eB,shader:eG},eV.K,ex.N]))r.l.IncludesShadersStoreWGSL[e.name]||(r.l.IncludesShadersStoreWGSL[e.name]=e.shader);let eY={name:eH,shader:eW}}}]);