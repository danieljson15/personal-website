"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[5182],{95182:(e,i,n)=>{n.r(i),n.d(i,{pbrPixelShader:()=>ez});var a=n(35614),r=n(64381),f=n(53262),o=n(6474),t=n(51305);let c="pbrFragmentDeclaration",l=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;a.l.IncludesShadersStore[c]||(a.l.IncludesShadersStore[c]=l);var d=n(28674),s=n(56503),E=n(96830),R=n(29680),C=n(96420),S=n(49030),u=n(74278),I=n(34098);let A="samplerFragmentAlternateDeclaration",m=`#ifdef _DEFINENAME_
...
#endif
#endif
`;a.l.IncludesShadersStore[A]||(a.l.IncludesShadersStore[A]=m);var v=n(75037);let T="pbrFragmentSamplersDeclaration",N=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;a.l.IncludesShadersStore[T]||(a.l.IncludesShadersStore[T]=N);var O=n(22216),_=n(84010),p=n(22391),L=n(99058),M=n(71167),D=n(24755),h=n(59286),P=n(6317),F=n(3271),g=n(71649),U=n(66632),b=n(10455),y=n(94036),B=n(48109),G=n(69980),V=n(99641),H=n(80543),W=n(15460),x=n(93052),Y=n(26540),X=n(15111),k=n(21843),w=n(17447);let K="pbrBlockAlbedoOpacity",z=`struct albedoOpacityOutParams
...
`;a.l.IncludesShadersStore[K]||(a.l.IncludesShadersStore[K]=z);let Z="pbrBlockReflectivity",q=`struct reflectivityOutParams
...
`;a.l.IncludesShadersStore[Z]||(a.l.IncludesShadersStore[Z]=q);let J="pbrBlockAmbientOcclusion",j=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;a.l.IncludesShadersStore[J]||(a.l.IncludesShadersStore[J]=j);let Q="pbrBlockAlphaFresnel",$=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;a.l.IncludesShadersStore[Q]||(a.l.IncludesShadersStore[Q]=$);let ee="pbrBlockAnisotropic",ei=`#ifdef ANISOTROPIC
...
#endif
`;a.l.IncludesShadersStore[ee]||(a.l.IncludesShadersStore[ee]=ei);let en="pbrBlockReflection",ea=`#ifdef REFLECTION
...
#endif
`;a.l.IncludesShadersStore[en]||(a.l.IncludesShadersStore[en]=ea);let er="pbrBlockSheen",ef=`#ifdef SHEEN
...
#endif
`;a.l.IncludesShadersStore[er]||(a.l.IncludesShadersStore[er]=ef);let eo="pbrBlockClearcoat",et=`struct clearcoatOutParams
...
return outParams;}
#endif
`;a.l.IncludesShadersStore[eo]||(a.l.IncludesShadersStore[eo]=et);let ec="pbrBlockIridescence",el=`struct iridescenceOutParams
...
#endif
`;a.l.IncludesShadersStore[ec]||(a.l.IncludesShadersStore[ec]=el);let ed="pbrBlockSubSurface",es=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;a.l.IncludesShadersStore[ed]||(a.l.IncludesShadersStore[ed]=es);var eE=n(65014);let eR="pbrBlockReflectance0",eC=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;a.l.IncludesShadersStore[eR]||(a.l.IncludesShadersStore[eR]=eC);let eS="pbrClusteredLightingFunctions",eu=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;a.l.IncludesShadersStore[eS]||(a.l.IncludesShadersStore[eS]=eu);var eI=n(68398),eA=n(60469),em=n(98786);let ev="pbrBlockNormalFinal",eT=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;a.l.IncludesShadersStore[ev]||(a.l.IncludesShadersStore[ev]=eT);var eN=n(44925);let eO="pbrBlockLightmapInit",e_=`#ifdef LIGHTMAP
...
#endif
`;a.l.IncludesShadersStore[eO]||(a.l.IncludesShadersStore[eO]=e_);let ep="pbrBlockGeometryInfo",eL=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;a.l.IncludesShadersStore[ep]||(a.l.IncludesShadersStore[ep]=eL);let eM="pbrBlockReflectance",eD=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;a.l.IncludesShadersStore[eM]||(a.l.IncludesShadersStore[eM]=eD);let eh="pbrBlockDirectLighting",eP=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;a.l.IncludesShadersStore[eh]||(a.l.IncludesShadersStore[eh]=eP);var eF=n(62546);let eg="pbrBlockFinalLitComponents",eU=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;a.l.IncludesShadersStore[eg]||(a.l.IncludesShadersStore[eg]=eU);let eb="pbrBlockFinalUnlitComponents",ey=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;a.l.IncludesShadersStore[eb]||(a.l.IncludesShadersStore[eb]=ey);let eB="pbrBlockFinalColorComposition",eG=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;a.l.IncludesShadersStore[eB]||(a.l.IncludesShadersStore[eB]=eG);var eV=n(60889),eH=n(72358),eW=n(95827);let ex="pbrBlockPrePass",eY=`#if SCENE_MRT_COUNT>0
#ifdef ALPHATEST
...
#ifdef SS_SCATTERING
#ifdef PREPASS_COLOR
WRITE_GEOMETRY_FRAGMENT_OUTPUT(PREPASS_COLOR_INDEX,vec4(finalColor.rgb-irradiance,finalColor.a)); 
#endif
irradiance/=sqAlbedo;
#else
#ifdef PREPASS_COLOR
WRITE_GEOMETRY_FRAGMENT_OUTPUT(PREPASS_COLOR_INDEX,finalColor); 
#endif
float scatteringDiffusionProfile=255.;
#endif
WRITE_GEOMETRY_FRAGMENT_OUTPUT(PREPASS_IRRADIANCE_LEGACY_INDEX,vec4(clamp(irradiance,vec3(0.),vec3(1.)),writeGeometryInfo*scatteringDiffusionProfile/255.)); 
#else
...
#endif
#endif
`;a.l.IncludesShadersStore[ex]||(a.l.IncludesShadersStore[ex]=eY);var eX=n(8110),ek=n(15529);let ew="pbrPixelShader",eK=`#define PBR_FRAGMENT_SHADER
