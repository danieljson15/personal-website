"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[3001],{37422:(e,t,r)=>{r.d(t,{n:()=>a});var n=r(35614);let i="bakedVertexAnimation",f=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;n.l.IncludesShadersStoreWGSL[i]||(n.l.IncludesShadersStoreWGSL[i]=f);let a={name:i,shader:f}},48815:(e,t,r)=>{r.d(t,{y:()=>a});var n=r(35614);let i="clipPlaneVertex",f=`#ifdef CLIPPLANE
...
#endif
`;n.l.IncludesShadersStoreWGSL[i]||(n.l.IncludesShadersStoreWGSL[i]=f);let a={name:i,shader:f}},49436:(e,t,r)=>{r.d(t,{l:()=>a});var n=r(35614);let i="bonesVertex",f=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;n.l.IncludesShadersStoreWGSL[i]||(n.l.IncludesShadersStoreWGSL[i]=f);let a={name:i,shader:f}},51457:(e,t,r)=>{r.d(t,{c:()=>a});var n=r(35614);let i="clipPlaneVertexDeclaration",f=`#ifdef CLIPPLANE
...
#endif
`;n.l.IncludesShadersStoreWGSL[i]||(n.l.IncludesShadersStoreWGSL[i]=f);let a={name:i,shader:f}},72486:(e,t,r)=>{r.d(t,{j:()=>a});var n=r(35614);let i="bonesDeclaration",f=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;n.l.IncludesShadersStoreWGSL[i]||(n.l.IncludesShadersStoreWGSL[i]=f);let a={name:i,shader:f}},86527:(e,t,r)=>{r.d(t,{Y:()=>a});var n=r(35614);let i="morphTargetsVertexDeclaration",f=`#ifdef MORPHTARGETS
...
#endif
#endif
`;n.l.IncludesShadersStoreWGSL[i]||(n.l.IncludesShadersStoreWGSL[i]=f);let a={name:i,shader:f}},87946:(e,t,r)=>{r.d(t,{J:()=>a});var n=r(35614);let i="bakedVertexAnimationDeclaration",f=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;n.l.IncludesShadersStoreWGSL[i]||(n.l.IncludesShadersStoreWGSL[i]=f);let a={name:i,shader:f}},88782:(e,t,r)=>{r.d(t,{f:()=>a});var n=r(35614);let i="morphTargetsVertexGlobal",f=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
var vertexID : f32;
#endif
#endif
`;n.l.IncludesShadersStoreWGSL[i]||(n.l.IncludesShadersStoreWGSL[i]=f);let a={name:i,shader:f}},91050:(e,t,r)=>{r.d(t,{H:()=>a});var n=r(35614);let i="morphTargetsVertexGlobalDeclaration",f=`#ifdef MORPHTARGETS
...
#endif
#endif
`;n.l.IncludesShadersStoreWGSL[i]||(n.l.IncludesShadersStoreWGSL[i]=f);let a={name:i,shader:f}},92303:(e,t,r)=>{r.d(t,{K:()=>a});var n=r(35614);let i="instancesDeclaration",f=`#ifdef INSTANCES
...
#endif
#endif
`;n.l.IncludesShadersStoreWGSL[i]||(n.l.IncludesShadersStoreWGSL[i]=f);let a={name:i,shader:f}},93551:(e,t,r)=>{r.d(t,{U:()=>a});var n=r(35614);let i="instancesVertex",f=`#ifdef INSTANCES
...
#endif
#endif
`;n.l.IncludesShadersStoreWGSL[i]||(n.l.IncludesShadersStoreWGSL[i]=f);let a={name:i,shader:f}},94257:(e,t,r)=>{r.d(t,{g:()=>a});var n=r(35614);let i="morphTargetsVertex",f=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;n.l.IncludesShadersStoreWGSL[i]||(n.l.IncludesShadersStoreWGSL[i]=f);let a={name:i,shader:f}}}]);