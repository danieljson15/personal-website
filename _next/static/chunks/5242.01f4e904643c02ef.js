"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[5242],{95242:(e,t,r)=>{r.r(t),r.d(t,{passCubePixelShaderWGSL:()=>l});var u=r(35614);let a="passCubePixelShader",p=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_cube<f32>;
...
fragmentOutputs.color=textureSample(textureSampler,textureSamplerSampler,vec3f(uv,-1.001));
#endif
}`;u.l.ShadersStoreWGSL[a]||(u.l.ShadersStoreWGSL[a]=p);let l={name:a,shader:p}}}]);